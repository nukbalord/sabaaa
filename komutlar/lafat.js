exports.run = async (client, msg, args) => {//Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
    let kapak=[
      ...
      "Kimine göre kral, kimine göre yalanım... Unutmayın beyler adamına göre adamım... ",//Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
      ...
      "Senin etiketinin olduğu yerde fiyatı ben koyarım.",
      "Balonlar, içi boş şeylerin de bazen yükselebileceğini hatırlatır.",
      "Bazı insanları sarımsaklasak da mı saklasak, yoksa boğup da rahatlasak mı?",//Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
      "Laf sokma, kapak olursun. Yalvarma, köpek olursun. Delikanlı ol, belki yanımda yer bulursun.",
      "Laf Sokarim Derinden götün Oynar Yerinden",
      ...
      "Senin zirven benim zeminim! ",//Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
   ...
   description: (':no_entry_sign: Ya Kime Kapak Laf Soyluyecem?')//Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
  }});
    else{
