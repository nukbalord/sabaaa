...
exports.run = (client, message) => {
  message.channel.send("Espri yükleniyor.").then(message => {//Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
    var espriler = [
      "Seni görünce; \ngözlerim dolar, \nkulaklarım euro.",
      ...
      "Beni Ayda bir sinemaya götürme, Marsta bir sinemaya götür.",//Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
      ...
      "Ben kahve içiyorum, Nurgül Yeşilçay.",//Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ["espiri", "espri-yap", "yap-espri", "yapbi-espri"],//Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
  permLevel: 0
};

exports.help = {
  name: "espri",
  description: "Espri yapar.",//Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
  usage: "espri"
};//Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!