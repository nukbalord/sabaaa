...
exports.run = (client, message) => {
    let zulapng = "https://pbs.twimg.com/media/EBNNWy5XoAE7Xiu.jpg"///Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
    var destedencikanlar = [
        ...
        "M4A4 **Grafiti Desen**",
        "M4A1 **Ejder Desen**",
        "M4A1 **Köpek Balığı Anahtarlık**",///Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
        ...
        "AWP **Ekmek Anahtarlık**",///Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
        "AWP **Kabus Desen**",
        "MPT-76 **Sultan Desen**",
        ...
        "M468 **Kabus Desen**",///Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
        ...
        "M6 LWRC **Altın Desen**",///Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
        ...
        "Bora 12 **Kabus Desen**",
        "Bora 12 **Altın Desen**",
        "Bora 12 **Megatronik Desen**",///Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
        "Bora 12 **Ejder Desen**",
        ...
        "Desert Deagle **Ejder Desen**",///Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
    ...
    var destedencikanlar = destedencikanlar[Math.floor(Math.random(1) * destedencikanlar.length)]///Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
    ...
    .setFooter(`Desteyi açan (${message.author.username}) Unutma Bunlar Sadece Bir Simülatör Gerçek hesabına Gelmez`)///Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
    .setColor("BLACK")
    return message.channel.send(embed);
};

exports.conf = {///Airfax Youtube Kanalından Paylaşılmıştır Çalınması Suçtur!!!
  enabled: true,
  guildOnly: false,
  aliases: ['desteaç'],
  permLevel: 0,
